...
![alt text](./assets/commits-page.png)

2. 找到你想要生成增量文件提交点, 进入提交点详细提交页面

![alt text](./assets/commit-detail-page.png)

3. 在浏览器导航栏的当前url最后添加.patch, 然后访问

![alt text](./assets/url-add-patch.png)

![alt text](./assets/patch-content-page.png)

4. 在空白处右键, 另存为本地文件(文件名和文件后缀名可以随意修改, 但通常使用.patch或.diff)

![alt text](./assets/right-click-save-as.png)

![alt text](./assets/save-patch-file.png)
